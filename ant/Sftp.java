...
//  private File listing;
   ...
   * delete, or list.
   */
  protected int transferFiles(SftpClient sftp, FileSet fs) throws IOException,
      BuildException {
    FileScanner ds;
   ...
   * server.
   */
  protected void transferFiles(SftpClient sftp) throws IOException,
      BuildException {
    transferred = 0;
    skipped = 0;
    if (filesets.size() == 0) {
   ...
   * errors.
   */
  protected void createParents(SftpClient sftp, String filename) throws
   ...
   */
  protected void sendFile(SftpClient sftp, String dir, String filename) throws
      IOException, BuildException {
    InputStream instream = null;
    SftpFileOutputStream out = null;
    try {
      File file = parent.getProject().resolveFile(new File(dir, filename).
                                                  getPath());
      ...
      if (verbose) {
        log("transferring " + file.getAbsolutePath() + " to " + remotedir +
            remotefile);
      }
  ...
  protected void delFile(SftpClient sftp, String filename) throws IOException,
      BuildException {
    if (verbose) {
  ...
  protected void chmod(SftpClient sftp, String filename) throws IOException,
      BuildException {
   ...
   * the coding.</p>
   */
  protected void getFile(SftpClient sftp, String dir, String filename) throws
      IOException, BuildException {
    try {
      ...
      File file = parent.getProject().resolveFile(new File(dir, localfile).
                                                  getAbsolutePath());
      log(dir);
      log(filename);
   ...
   */
  protected void makeRemoteDir(SftpClient sftp, String dir) throws
      BuildException {
    if (verbose) {
